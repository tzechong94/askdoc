...
export async function POST(req: Request) {
  try {
    ...
    const prompt = {
      ...
      AI assistant will try to simplify explanation into laymen's term.
      AI assistant will advise to see a doctor if the conditions provided in context are serious.
      AI assistant will take into account any previous message that is provided in a conversation.
